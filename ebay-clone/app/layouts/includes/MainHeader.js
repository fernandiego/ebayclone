    ...
    return (
        <>
            <div id="MainHeader" className="border-b">
                <div className="flex items-center justify-between w-full mx-auto max-w-[1200]">
                    <div className="flex items-center w-full bg-white">
                        <div className="flex lg:justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto">
                            <Link href="/">
